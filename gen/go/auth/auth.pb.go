...
func (x *RegisterResponse) GetUserId() bool {
	if x != nil {
		return x.UserId
	}
	return false
...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\auser_id\x18\x01 \x01(\bR\x06userId\"W\n" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x14Z\x12user.auth.v1;apiv1b\x06proto3"
